...
public class OkanoFlatLitToonInspector : ShaderGUI
{
    ...
    public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] props)
    {
        ...
        { //Shader Properties GUI
            ...
            materialEditor.ShaderProperty(stencilRef, new GUIContent("Stencil Ref", "Value to use in the stencil buffer. Can only be seen by a mask of this same number."));
        }
