...
public class OkanoFlatLitToonSSparkleInspector : ShaderGUI
{
    ...
    MaterialProperty emissionNoiseCoeff;
    MaterialProperty emissionNoiseDensity;
    MaterialProperty emissionSparkleSpeed;
    MaterialProperty emissionGreyShift;
    ...
    public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] props)
    {
        { //Find Properties
            ...
            emissionNoiseCoeff = FindProperty("_EmissionNoiseSizeCoeff", props);
            emissionNoiseDensity = FindProperty("_EmissionNoiseDensity", props);
            emissionSparkleSpeed = FindProperty("_EmissionSparkleSpeed", props);
            emissionGreyShift = FindProperty("_EmissionGreyShift", props);
        }
        ...
        { //Shader Properties GUI
            ...
            EditorGUI.BeginChangeCheck();
            {
                ...
                materialEditor.TexturePropertySingleLine(new GUIContent("Emission", "Emission (RGB)"), emissionMap);
                EditorGUI.indentLevel += 2;
                materialEditor.ShaderProperty(emission, "Amount");
                materialEditor.ShaderProperty(emissionNoiseCoeff, "Noise Size Coeff");
                materialEditor.ShaderProperty(emissionNoiseDensity, "Noise Density");
                materialEditor.ShaderProperty(emissionSparkleSpeed, "Sparkle Speed");
                materialEditor.ShaderProperty(emissionGreyShift, "Grey Shift");
                EditorGUI.indentLevel -= 2;                
